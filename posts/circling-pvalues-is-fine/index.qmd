...
subtitle: You noticed that the p-values in a paper are close to .05. Does this make
  you a bad person? Can 'circling p-values' ever be a useful heuristic? My two cents
  on an (apparently?) controversial topic.
author:
- Quentin André
date: '2024-04-30'
