...
The second aspect (and the one I find most exciting) is that it gives ANYONE the opportunity to engage with the research at a deeper level. If my data, code, and materials are easily accessible and discoverable by LLMs, someone who wants to build upon my work (or someone who wants to scrutinize it!) no longer has to email me and wait for the details to come it. Instead, they can point an agent at the repository and ask "does this result hold if you handle outliers differently?", "what happens under a different specification?", "what is the exact wording of the dependent measures in study 2?"... and get the answer in a few minutes. For someone like me who keeps telling everyone to share as much as possible about their work, this is just the logical next step.
