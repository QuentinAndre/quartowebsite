...
description: This Python library implements Simonsohn, Simmons and Nelson's 'p-curve'
  analysis.
toc: false
---

<div class="software-links" style="margin-bottom: 1.5em;">
<a href="https://github.com/QuentinAndre/pypcurve" class="btn btn-outline-primary btn-sm" target="_blank" rel="noopener">See on GitHub</a>
</div>
